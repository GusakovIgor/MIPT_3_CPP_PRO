...
{	
	...
	Replace (0, (canvas_num % MAX_NUM_CANVASES_ON_PAGE) * 3 * dy / 2);
...
TurnPageButton::TurnPageButton (Shape* init_shape, Shape* init_collision, Texture* init_texture)
					  : Button (turn_page_t, init_shape, init_collision, init_texture)
{
}