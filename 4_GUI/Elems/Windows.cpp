...
int CanvasPointerPage::num_pages = 0;
...
void Container::Draw (Application* App)
{
}
...
CanvasPointerPage::CanvasPointerPage () : Window ()
{
	page_number = 0;

	num_canvas_pointers = 0;
}

CanvasPointerPage::CanvasPointerPage (Shape*   init_shape,
									  Shape*   init_collision,
									  Texture* init_texture) : Window (canvas_ptr_page_t, init_shape, init_collision, init_texture)
{
	num_canvas_pointers = 0;
...
bool CanvasPointerPage::Last ()
{
	return (page_number == num_pages);
}

bool CanvasPointerPage::Full ()
{
	return (num_canvas_pointers == MAX_NUM_CANVASES_ON_PAGE);
}
...
Pages::Pages (Shape*   init_shape,
		 	  Shape*   init_collision,
			  Texture* init_texture) : Window (pages_t, init_shape, init_collision, init_texture)
{
	active = 0;
}
