...
Window* ElementCreator::NewWindow (ElemConfig* config)
{
	...
	{		
		...
		case canvas_ptr_page_t  : return new CanvasPointerPage (init_shape, init_collision, init_texture);
		
		case pages_t  			: return new Pages 			   (init_shape, init_collision, init_texture);
...
Button* ElementCreator::NewButton (ElemConfig* config)
{
	...
	{		
		...
		case turn_page_t		  : return new TurnPageButton		  (init_shape, init_collision, init_texture);
...
WindowType WindowTypeForName (const char* type_name)
{
	...
	else if (strcmp (type_name, "CanvasPointerPage") == 0)
	{
		return canvas_ptr_page_t;
	}
...
ButtonType ButtonTypeForName (const char* type_name)
{
	...
	else if (strcmp (type_name, "TurnPage") == 0)
	{
		return turn_page_t;
	}
	else
