...
{
	float width  = right_border () - left_border ();
	float height = down_border ()  - up_border ();
	...
	DrawText (App, Point (left.x + x_shift, left.y + y_shift), Point (right.x - x_shift, right.y - y_shift), label);
}
...
void Rectangle::DrawTexture (Application* App, Point left, Point right, Texture* texture)
{
	assert (left_border () <= left.x  <= right_border ());
	assert (left_border () <= right.x <= right_border ());
...
void Circle::DrawTexture (Application* App, Point left, Point right, Texture* texture)
{
	assert (left_border () <= left.x  <= right_border ());
	assert (left_border () <= right.x <= right_border ());
...
void RoundedRect::DrawLabel (Application* App, const char* label)
{
	...
	App->DrawText (label, Point (left.x + x_shift, left.y + y_shift), Point (right.x - x_shift, right.y - y_shift), GetColour ());
}
...
void RoundedRect::DrawTexture (Application* App, Point left, Point right, Texture* texture)
{
	assert (left_border () <= left.x  <= right_border ());
	assert (left_border () <= right.x <= right_border ());
