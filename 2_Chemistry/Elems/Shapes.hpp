...
public:
	...
	virtual void DrawTexture (Application* App, Point left, Point right, Texture* texture) = 0;
...
public:
	...
	void DrawTexture (Application* App, Point left, Point right, Texture* texture);
